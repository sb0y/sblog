...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	*/
	function getUserProfile()
	{
		...
		// resolve link and try to get real img link
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 
		    "https://graph.facebook.com/" . $this->user->profile->identifier . "/picture?type=large");
		...
		$this->user->profile->photoURL = curl_getinfo ($ch, CURLINFO_EFFECTIVE_URL);
